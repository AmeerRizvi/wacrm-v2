...
// closed), `?contact_id=`, and `?channel_id=`. Each conversation embeds
// its contact + tags via the shared CONVERSATION_SELECT.
// ============================================================
...
export async function GET(request: Request) {
  try {
    ...
    if (channelId) query = query.eq('whatsapp_config_id', channelId);
